...
function Card({ children, style = {}, glowColor }) {
  return (
    <div
      style={{
        position: "relative",
        borderRadius: 16, // Reduced from 18 to match workspace panel
  ...
  return (
    <p
      style={{
        ...
        fontSize: 13, // Scaled down from 22
        letterSpacing: "4px", // Balanced tracking
        textTransform: "uppercase",
        color: "rgba(140,155,195,0.5)",
        marginBottom: 16, // Tighter gap
      }}
    >
      {children}
    </p>
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        padding: "40px 5vw 40px", // Shrunk top padding from 180px to pull content up
        overflowY: "auto",
      }}
      variants={pv}
      initial="hidden"
    ...
    >
      ...
      <motion.div
        variants={row}
        style={{ textAlign: "center", marginBottom: 32 }} // Shrunk from 90 to look integrated
      >
        <h1
          style={{
            fontFamily: "'Space Mono', monospace",
            fontSize: "clamp(22px, 2.5vw, 34px)", // Shrunk from 52px-72px
            fontWeight: 400,
      ...
      <div
        style={{
          width: "100%",
          maxWidth: "min(1050px, 88vw)", // Matched with Analysis Workspace max width
          display: "flex",
          flexDirection: "column",
          gap: 16, // Brought cards tighter together
        }}
      >
        {/* ── Status row ── */}
        <motion.div
        ...
        >
          ...
          <Card
            style={{
              ...
              padding: "16px 24px", // Shrunk from 28px 40px
            }}
          >
        ...
        <motion.div variants={row}>
          <Card
            glowColor={accent}
            style={{
              padding: "40px 44px", // Shrunk padding down significantly
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
              <div
                style={{
                  width: 4,
                  flexShrink: 0,
                  height: 50, // Reduced height to align better with compressed title text
                  borderRadius: 999,
              ...
              <span
                style={{
                  fontFamily: "'Space Mono', monospace",
                  fontSize: "clamp(24px, 3vw, 38px)", // Shrunk from 36px-56px
                  fontWeight: 400,
                  lineHeight: 1.1,
        ...
        <motion.div variants={row}>
          <Card
            style={{
              padding: "36px 44px", // Condensed from 50px 72px
          ...
          >
            ...
            <p
              style={{
                fontFamily: "'Inter', sans-serif",
                fontSize: "clamp(15px, 1.2vw, 18px)", // Drastically reduced down from giant 26px-34px text
                fontWeight: 300,
                lineHeight: 1.75,
        ...
        <motion.div variants={row}>
          <Card
            style={{
              padding: "32px 44px", // Balanced with upper components
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
              <span
                style={{
                  fontFamily: "'Space Mono', monospace",
                  fontSize: "clamp(20px, 2.2vw, 28px)", // Reduced from 24px-40px
                  fontWeight: 400,
                  letterSpacing: "-0.5px",
        ...
        <motion.div
          ...
          style={{
            display: "flex",
            justifyContent: "center",
            paddingTop: 36, // Pulled back significantly
            paddingBottom: 24,
          }}
        >
          <motion.button
            ...
            style={{
              fontFamily: "'Space Mono', monospace",
              fontSize: 16, // Normalized with workspace buttons
              letterSpacing: "3px",
              textTransform: "uppercase",
              color: "#d4aaff",
              padding: "14px 46px", // Matched back button action scale
              borderRadius: 999,
